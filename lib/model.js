...
var statics = {
  create: function(data, cb) {
    var doc = new this.prototype.constructor(data);

    driver.create(this.table, doc._doc, function(err, res) {
  ...
  update: function(query, data, cb) {
    driver.update(this.table, this.schema.filter(data), function(err, res) {
      if (err) return cb(err);
